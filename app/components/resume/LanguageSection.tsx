    ...
    <>
      ...
      <Modal
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 space-y-2">
              <label className="flex items-center gap-2">
                ...
                <span className="text-sm text-black">시(영)원어 자(민)어(상)</span>
              </label>
              <label className="flex items-center gap-2">
              ...
              <label className="flex items-center gap-2">
                ...
                <span className="text-sm text-black">미(영)언어 아(민)어 능 월기2)</span>
              </label>
            </div>
          </div>
          <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <label className="w-32 text-sm text-black">파생일부</label>
            <input
              type="text"
