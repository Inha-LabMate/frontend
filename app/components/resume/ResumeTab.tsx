...
export default function ResumeTab() {const { t } = useTranslation();
  ...
  if (isLoading) {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-600">{t("이력서를 불러오는 중입니다...")}</p>
      </div>);
  ...
  if (!resume) {
    return (
      <div className="text-center py-8 text-gray-500">{t("이력서 정보를 불러올 수 없습니다.")}
  ...
  return (
    <div className="w-full relative">
      ...
      <div className="flex justify-end mb-4">
        <button className="px-6 py-2 bg-inha-blue text-white rounded hover:opacity-90 transition-opacity">{t("저장")}
