...
export default function AIRecommendation() {const { t } = useTranslation();
      ...
      <div className="w-full">
        <div className="bg-gray-50 p-12 rounded-lg text-center">
          <div className="max-w-md mx-auto">
            <h2 className="text-xl font-medium text-gray-800 mb-3">{t("나에게 적합한 연구실을 찾고 계신가요?")}

            </h2>
            <p className="text-gray-600 mb-6">{t("AI가 입력하신 이력서 정보를 기반으로")}

              <br />{t("맞춤형 연구실을 추천해드립니다.")}

            </p>
            <button
              onClick={handleStartRecommendation}
              className="px-8 py-3 bg-white text-gray-700 rounded-lg border-2 border-gray-300 hover:border-inha-blue hover:text-inha-blue transition-colors font-medium">{t("AI 추천 시작")}
      ...
      <div className="w-full">
        <div className="bg-gray-50 p-12 rounded-lg text-center">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-gray-600">{t("AI가 맞춤형 연구실을 분석하고 있습니다...")}
  ...
  if (viewState === "no-resume") {
    return (
      <div className="w-full">
        <div className="bg-gray-50 p-12 rounded-lg text-center">
          <div className="max-w-md mx-auto">
            <p className="text-gray-700 mb-2">{t("※ 이력서 정보가 등록되어 있지 않습니다.")}

            </p>
            <p className="text-gray-600 mb-6">{t("AI 추천을 위해 이력서를 먼저 작성해주세요.")}

            </p>
            <button
              onClick={handleGoToResume}
              className="px-8 py-3 bg-white text-gray-700 rounded-lg border-2 border-gray-300 hover:border-inha-blue hover:text-inha-blue transition-colors font-medium">{t("이력서 관리 페이지로 이동")}
  ...
  if (viewState === "results" && recommendedLabs) {
    return (
      <div className="w-full">
        <h2 className="text-xl font-bold text-gray-800 mb-4">{t("AI 연구실 추천 결과")}
        ...
        <div className="border border-gray-300 overflow-x-auto rounded-lg">
          ...
          <div className="grid grid-cols-[80px_1fr_200px_1fr] bg-blue-100 border-b border-gray-300 min-w-[700px]">
            <div className="px-4 py-3 text-center font-medium text-gray-800 border-r border-gray-300">{t("순위")}

            </div>
            <div className="px-4 py-3 text-center font-medium text-gray-800 border-r border-gray-300">{t("연구실명 / 지도교수 / 연구내용")}

            </div>
            <div className="px-4 py-3 text-center font-medium text-gray-800 border-r border-gray-300">{t("적합도 / 예상합격률")}

            </div>
            <div className="px-4 py-3 text-center font-medium text-gray-800">{t("추천이유")}
            ...
            <div
              ...
              className="grid grid-cols-[80px_1fr_200px_1fr] border-b border-gray-200 hover:bg-gray-50 transition-colors min-w-[700px]">
                ...
                <div className="px-4 py-6 border-r border-gray-200">
                  ...
                  <div className="text-sm text-gray-700">{t("- 연구내용 :")}
                ...
                <div className="px-4 py-6 border-r border-gray-200 text-center">
                  <div className="mb-4">
                    ...
                    <div className="text-lg font-semibold text-inha-blue">{t("예상합격률")}
        ...
        <div className="mt-6 flex justify-center">
          <button
            ...
            className="px-6 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 transition-colors">{t("다시 추천받기")}
