...
export default function GraduateResearchTable() {const { t } = useTranslation();
  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-900 mb-4">{t("대학원 연구실 리스트")}
