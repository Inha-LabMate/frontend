...
export default function GraduateContactPage() {
  ...
  // Zustand store에서 이력서/자기소개서 데이터 가져오기
  const { resume, selfIntro } = useResumeStore();
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <select
              ...
              <option value={t("학과")} className="bg-white text-black">
                {t("학과")}
              </option>
              <option value={t("연구실")} className="bg-white text-black">
                {t("연구실")}
              </option>
              <option value={t("교수")} className="bg-white text-black">
                {t("교수")}
              </option>
            </select>
            ...
            <select
              ...
              className="px-4 py-2 border border-gray-300 rounded-md text-sm text-black bg-white focus:ring-2 focus:ring-inha-blue focus:border-inha-blue">
              <option value={t("세부전공")} className="bg-white text-black">
                {t("세부전공")}
              </option>
              <option value={t("전공")} className="bg-white text-black">
                {t("전공")}
              </option>
            </select>
              ...
              <div className="border border-gray-200 rounded-lg overflow-x-auto">
                ...
                <div className="p-6 bg-gray-50">
                  <div className="mb-4">
                    ...
                    {/* 이력서 썸네일 */}
                    {newContact.이력서연동 && (
                      <div className="ml-4 mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        ...
                        <div className="space-y-2 text-xs text-gray-700">
                          ...
                          {resume.experiences.length > 0 && (
                            <div className="mt-2 pt-2 border-t border-blue-200">
                              ...
                              {resume.experiences.length}개
                            </div>
                          )}
                          {resume.projects.length > 0 && (
                            <div>
                              <span className="font-medium">프로젝트:</span>{" "}
                              {resume.projects.length}개
                            </div>
                          )}
                          {resume.tech_stack && (
                            <div>
                              <span className="font-medium">기술스택:</span>{" "}
                              {resume.tech_stack.substring(0, 50)}
                              {resume.tech_stack.length > 50 ? "..." : ""}
                            </div>
                          )}
                        </div>
                      </div>
                    ...
                    {/* 자기소개서 썸네일 */}
                    {newContact.자기소개서연동 && (
                      <div className="ml-4 mb-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                        <h4 className="text-sm font-semibold text-green-900 mb-2">
                          📝 연동된 자기소개서
                        </h4>
                        <div className="space-y-2 text-xs text-gray-700">
                          {selfIntro.research_interests && (
                            <div>
                              <span className="font-medium">연구 관심사:</span>
                              <p className="mt-1 text-gray-600">
                                {selfIntro.research_interests.substring(0, 100)}
                                {selfIntro.research_interests.length > 100
                                  ? "..."
                                  : ""}
                              </p>
                            </div>
                          ...
                          {selfIntro.intro1 && (
                            <div className="pt-2 border-t border-green-200">
                              <span className="font-medium">문항 1:</span>
                              <p className="mt-1 text-gray-600">
                                {selfIntro.intro1.substring(0, 80)}
                                {selfIntro.intro1.length > 80 ? "..." : ""}
                              </p>
                            </div>
                          )}
                          {selfIntro.intro2 && (
                            <div className="pt-2 border-t border-green-200">
                              <span className="font-medium">문항 2:</span>
                              <p className="mt-1 text-gray-600">
                                {selfIntro.intro2.substring(0, 80)}
                                {selfIntro.intro2.length > 80 ? "..." : ""}
                              </p>
                            </div>
                          )}
                          {selfIntro.intro3 && (
                            <div className="pt-2 border-t border-green-200">
                              <span className="font-medium">문항 3:</span>
                              <p className="mt-1 text-gray-600">
                                {selfIntro.intro3.substring(0, 80)}
                                {selfIntro.intro3.length > 80 ? "..." : ""}
                              </p>
                            </div>
                          )}
                        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <select
              ...
              className="px-4 py-2 border border-gray-300 rounded-md text-sm text-black bg-white focus:ring-2 focus:ring-inha-blue focus:border-inha-blue">
              <option value={t("전체")} className="bg-white text-black">
                {t("전체")}
              </option>
            ...
            <select
              ...
              <option value={t("컴퓨터공학과")} className="bg-white text-black">
                {t("컴퓨터공학과")}
              </option>
              <option
                value={t("전기컴퓨터공학과")}
            ...
            <select
              ...
              <option value={t("대기")} className="bg-white text-black">
                {t("대기중")}
              </option>
              <option value={t("완료")} className="bg-white text-black">
                {t("승인")}
              </option>
              <option value={t("거절")} className="bg-white text-black">
                {t("거절")}
              </option>
            </select>
